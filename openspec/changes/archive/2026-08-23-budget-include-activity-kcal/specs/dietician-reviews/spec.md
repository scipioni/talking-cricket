...
- For a **month** or **year** period, the recommendation SHALL be framed as a general health habit to adopt going forward, and SHALL explicitly address macronutrient balance (protein, fat and carbohydrate variety) in qualitative terms, without stating a specific gram amount of any macronutrient, since the system does not track macronutrients as structured data.
